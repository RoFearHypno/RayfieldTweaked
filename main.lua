-- Tiny tweaks from https://raw.githubusercontent.com/SiriusSoftwareLtd/Rayfield/main/source.lua. (Just added :SetVisible(bool) to some)
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image)
		...
		function Tab:CreateButton(ButtonSettings)
            ...
            function ButtonValue:SetVisible(bool)
                Button.Visible = bool
            end
		...
		function Tab:CreateSlider(SliderSettings)
            ...
            function SliderSettings:SetVisible(bool)
                Slider.Visible = bool
            end
